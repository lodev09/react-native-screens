...
var _SheetTranslationContext = _interopRequireDefault(require("../SheetTranslationContext"));
...
const InnerScreen = exports.InnerScreen = /*#__PURE__*/_react.default.forwardRef(function InnerScreen(props, ref) {
  ...
  const translationY = _react.default.useRef(new _reactNative.Animated.Value(0)).current;
  const {
  ...
  if (enabled && _core.isNativePlatformSupported) {
    ...
    return /*#__PURE__*/_react.default.createElement(_DelayedFreeze.default, {
      ...
      onSheetTranslation: !isNativeStack ? undefined : _reactNative.Animated.event([{
        nativeEvent: {
          y: translationY
        }
      }], {
    ...
    children : /*#__PURE__*/_react.default.createElement(_SheetTranslationContext.default.Provider, {
      value: translationY
    }, /*#__PURE__*/_react.default.createElement(_TransitionProgressContext.default.Provider, {
      value: {
        progress,
        closing,
        goingForward

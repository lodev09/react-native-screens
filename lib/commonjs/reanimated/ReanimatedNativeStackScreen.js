...
const ReanimatedNativeStackScreen = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  const statusBarHeight = (0, _getStatusBarHeight.default)(insets.top, dimensions, isStatusBarTranslucent);
  ...
  const translationOffset = _reactNative.Platform.OS === 'android' ? insets.top + insets.bottom : 0;
  const translationY = (0, _reactNativeReanimated.useSharedValue)(dimensions.height - translationOffset);
  ...
  , _extends({
    ...
    onSheetTranslationReanimated: (0, _reactNativeReanimated.useEvent)(event => {
      'worklet';

      translationY.value = event.y - translationOffset;
    }, [
    // @ts-ignore wrong type
    _reactNative.Platform.OS === 'android' ? 'onSheetTranslation' : ENABLE_FABRIC ? 'onSheetTranslation' : 'topSheetTranslation']),
  ...
  }, rest), /*#__PURE__*/_react.default.createElement(_ReanimatedSheetTranslationContext.default.Provider, {
    value: translationY
  }, /*#__PURE__*/_react.default.createElement(_ReanimatedHeaderHeightContext.default.Provider, {
    value: headerHeight

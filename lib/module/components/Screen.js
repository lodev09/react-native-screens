...
export const InnerScreen = /*#__PURE__*/React.forwardRef(function InnerScreen(props, ref) {
  ...
  if (enabled && isNativePlatformSupported) {
    ...
    return /*#__PURE__*/React.createElement(DelayedFreeze, {
      ...
      onSheetTranslation: !isNativeStack ? undefined : Animated.event([{
        nativeEvent: {
          y: translationY
        }
      }], {
    ...
    children : /*#__PURE__*/React.createElement(SheetTranslationContext.Provider, {
      value: translationY
    }, /*#__PURE__*/React.createElement(TransitionProgressContext.Provider, {
      value: {
        progress,
        closing,
        goingForward

...
const ReanimatedNativeStackScreen = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  const statusBarHeight = getStatusBarHeight(insets.top, dimensions, isStatusBarTranslucent);
  ...
  const translationOffset = Platform.OS === 'android' ? insets.top + insets.bottom : 0;
  ...
  , _extends({
    ...
    onSheetTranslationReanimated: useEvent(event => {
      'worklet';

      translationY.value = event.y - translationOffset;
    }, [
    // @ts-ignore wrong type
    Platform.OS === 'android' ? 'onSheetTranslation' : ENABLE_FABRIC ? 'onSheetTranslation' : 'topSheetTranslation']),
  ...
  }, rest), /*#__PURE__*/React.createElement(ReanimatedSheetTranslationContext.Provider, {
    value: translationY
  }, /*#__PURE__*/React.createElement(ReanimatedHeaderHeightContext.Provider, {
    value: headerHeight
